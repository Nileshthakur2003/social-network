...
<head>
    ...
    <script type="text/javascript">
        ...
        function showCurrentMessage(obj){
            ...
            const sender = obj.children[1].innerText;
            const time_stamp = obj.children[2].innerText;

            document.getElementById("msgTitle").innerHTML = "Recieved from : "+sender+"<br>Time : "+time_stamp;
...
<span class='pure-button' style="float:left;margin:20px" onclick="window.location='index.php'">< Back to Home</span><h1 style="display:inline-block;margin-left:-10%;"><i class="fa fa-download" aria-hidden="true"></i>&nbsp;Inbox</h1>
<hr>
    <?php
...
if(isset($_COOKIE['usertoken'])){
    $hashed_username = $_COOKIE['usertoken'];
        ...
        echo "<th><tr><td>Message</td><td>Sent By</td><td>TimeStamp</td></tr></th>";
    ...
    if(mysqli_num_rows($result)>0){
     while($row = mysqli_fetch_assoc($result)){
        echo "<tr onclick='showCurrentMessage(this)'><td>".$row['content']."</td><td>".$row['source']."</td><td>".$row['time_st']."</td></tr>";
     }   
    }else{
